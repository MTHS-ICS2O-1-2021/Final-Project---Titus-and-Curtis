 ...
 */
 ...
 preload() {
   ...
   this.load.image('startButtonNormalHover', 'assets/normal_start_button_hover.png')
  ...
  create(data) {
    ...
    this.startButtonNormal.on('pointerover', function() {this.setTint(0xccffce)})
    this.startButtonNormal.on('pointerout', function() {this.clearTint()})
    ...
    this.startButtonHard.on('pointerover', function() {this.setTint(0xfac5c5)})
    this.startButtonHard.on('pointerout', function() {this.clearTint()})
