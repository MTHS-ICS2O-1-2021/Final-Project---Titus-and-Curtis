 ...
 */
 class ControlsScene extends Phaser.Scene {
    ...
    constructor() {
      ...
      this.controlsSceneTextStyle = { font: '60px Times', fill: '#ffffff', align: 'center',}
    }
    ...
    create(data) {
      ...
      this.controls = this.add.sprite(1080 / 2, (440 / 2) + 100, 'controls').setScale(1.50)
  
      this.controlsSceneText = this.add.text(1080 / 2, 1280 / 2, 'Use arrow keys or WASD to move', this.controlsSceneTextStyle).setOrigin(0.5)
    }
